...
part of 'search_product_request_model.dart';
...
/// @nodoc
mixin _$SearchProductRequestModel {
  String? get text => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $SearchProductRequestModelCopyWith<SearchProductRequestModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SearchProductRequestModelCopyWith<$Res> {
  factory $SearchProductRequestModelCopyWith(SearchProductRequestModel value,
          $Res Function(SearchProductRequestModel) then) =
      _$SearchProductRequestModelCopyWithImpl<$Res, SearchProductRequestModel>;
  @useResult
  $Res call({String? text});
}

/// @nodoc
class _$SearchProductRequestModelCopyWithImpl<$Res,
        $Val extends SearchProductRequestModel>
    implements $SearchProductRequestModelCopyWith<$Res> {
  _$SearchProductRequestModelCopyWithImpl(this._value, this._then);
...
class __$$SearchProductRequestEntityImplCopyWithImpl<$Res>
    extends _$SearchProductRequestModelCopyWithImpl<$Res,
...
class _$SearchProductRequestEntityImpl implements _SearchProductRequestEntity {
  ...
  @override
  String toString() {
    return 'SearchProductRequestModel(text: $text)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$SearchProductRequestEntityImplToJson(
      this,
    );
  }
}
...
abstract class _SearchProductRequestEntity
    implements SearchProductRequestModel {
