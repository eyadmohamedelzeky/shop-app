...
import '../../domain/entities/login_response_entity.dart' as _i3;
import '../models/login_response_model.dart' as _i2;

/// {@template package:taskassginment/app/login_screen/data/mappr/login_response_mappr.dart}
/// Available mappings:
/// - `LoginResponseModel` → `LoginResponseEntity`.
/// - `DataResponseModel` → `DataResponseEntity`.
/// {@endtemplate}
class $LoginResponeMappr implements _i1.AutoMapprInterface {
  const $LoginResponeMappr();
  ...
  /// {@macro package:taskassginment/app/login_screen/data/mappr/login_response_mappr.dart}
  @override
